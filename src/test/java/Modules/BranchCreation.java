...
public class BranchCreation {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		d.findElement(By.xpath("//input[@id='brancd']")).sendKeys("101123");
		d.findElement(By.xpath("//input[@id='brannm']")).sendKeys("Palur");
		Select branch = new Select(d.findElement(By.xpath("//select[@id='mainCd']")));
		branch.selectByValue("MAIN");
		d.findElement(By.xpath("//input[@id='address1']")).sendKeys("Chennai");
		JavascriptExecutor js = (JavascriptExecutor) d;
		js.executeScript("window.scrollBy(0,500)");
		d.findElement(By.xpath("//input[@id='bsrcode']")).sendKeys("1234554");
	...
	for(WebElement dd: day) {
		if(dd.getText().equalsIgnoreCase("5")) {
			dd.click();
			break;
		}
	}
		Select BRType =new Select(d.findElement(By.xpath("//select[@id='catogry']")));
		BRType.selectByVisibleText("Rural");
		Select RBIAtype=new Select(d.findElement(By.xpath("//select[@id='rbiaType']")));
		RBIAtype.selectByVisibleText("REGULAR");
		d.findElement(By.xpath("//input[@id='city']")).sendKeys("Chennai");
		d.findElement(By.xpath("//input[@id='pinNum']")).sendKeys("606908");
		...
		Thread.sleep(3000);
		 ...
		 {
			 if(st.getText().equalsIgnoreCase("01-ASSAM")) {
				 st.click();
					 break;
			 }
		 }
		 Thread.sleep(3000);
			  ...
			  for(WebElement DI:District) { 
				  if(DI.getText().contains("43-G"))
				  { 
					  DI.click();
			  break;
			  } } 
			  Thread.sleep(3000);
			  d.findElement(By.xpath("//input[@id='email']")).sendKeys("renukumar@gmail.com");
			  d.findElement(By.xpath("//select[@id='forEx']")).click();
			  Thread.sleep(3000);
			  Select Foreign = new Select(d.findElement(By.xpath("//select[@id='forEx']")));
			  Foreign.selectByVisibleText("A");
			 d.findElement(By.xpath("//input[@id='fromval']")).sendKeys("12");
			  d.findElement(By.xpath("//input[@id='toval']")).sendKeys("21");
			  Select Weekly=new Select(d.findElement(By.xpath("//select[@id='wklyFull']")));
			  Weekly.selectByVisibleText("Sunday");
			  Thread.sleep(3000); 
		     ...
		     {
		    	 if(CA.getText().contains("PER-PERSONAL BANKING"))
		    	 {CA.click();
	}
